...
st.caption(
    ...
    "'Unmet-Demand Penalty Cost' is Exhibit D's per-kL penalty applied directly — see "
    "**Production Plan → Unmet Demand** for the per-SKU/CFA detail behind this figure."
)
